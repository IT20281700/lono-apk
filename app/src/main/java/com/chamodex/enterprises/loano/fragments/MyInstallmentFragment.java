...
public class MyInstallmentFragment extends Fragment {
    FirebaseAuth auth;
    public MyInstallmentFragment(FirebaseAuth auth) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_installment, container, false);
        // content here
